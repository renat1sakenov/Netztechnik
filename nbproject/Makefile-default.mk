...
SOURCEFILES_QUOTED_IF_SPACED=busyxlcd.c main.c openxlcd.c putrxlcd.c putsxlcd.c readaddr.c readdata.c setcgram.c setddram.c wcmdxlcd.c writdata.c adcbusy.c adcclose.c adcconv.c adcopen.c adcread.c adcselchconv.c adcsetch.c
...
# Source Files
SOURCEFILES=busyxlcd.c main.c openxlcd.c putrxlcd.c putsxlcd.c readaddr.c readdata.c setcgram.c setddram.c wcmdxlcd.c writdata.c adcbusy.c adcclose.c adcconv.c adcopen.c adcread.c adcselchconv.c adcsetch.c
